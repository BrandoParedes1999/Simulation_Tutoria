...
{
    // Constantes del sistema (escala 0-100)
    ...
    protected $fillable = [
        'usuario_id',
        'matricula',
        'correo_institucional',     // ← nuevo: correo para enviar el código de registro
        'carrera_id',
        'semestre_actual',
        'fecha_ingreso',
        'tutor_id',
    ...
    /** Solo alumnos que ya completaron el registro (tienen cuenta) */
    public function scopeConCuenta($query)
    {
        return $query->whereNotNull('usuario_id');
    }

    /** Alumnos pre-registrados por admin que aún no crearon su cuenta */
